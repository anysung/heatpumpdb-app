...
/** Waving German flag — wavy cloth bands with a gentle sway (login header). */
export const WavingGermanFlag: React.FC<{ height?: number; className?: string }> = ({
  height = 40,
  className,
}) => (
  <svg
  ...
  >
    <g className="hp-flag-sway">
      ...
      {/* hairline so the black band reads on dark backgrounds */}
      <path d="M0 6 C16 0 32 12 48 6 C64 0 80 12 96 6 L96 60 C80 66 64 54 48 60 C32 66 16 54 0 60 Z" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
    </g>
  </svg>
);
