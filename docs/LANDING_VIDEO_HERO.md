...
| `src/index.css` | modified · common | `.hp-card-solid` — the login/signup card over the backdrop: dark 69 % pane + 22 px blur (owner 2026-09-23: 15 % more see-through than the first 84 %, so the clip's motion shows faintly) while the form still reads first. |
